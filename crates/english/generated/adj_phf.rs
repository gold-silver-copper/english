...
pub static ADJECTIVE_MAP: phf::Map<&'static str, (&'static str, &'static str)> = phf_map! {
    ...
    "base" => ("baser", "basest"),
    "basementy" => ("basementier", "basementiest"),
    ...
    "brotherly" => ("brotherlier", "brotherliest"),
    ...
    "cabbagey" => ("cabbagier", "cabbagiest"),
    "cabbagy" => ("cabbagier", "cabbagiest"),
    ...
    "central2" => ("more central", "centermost"),
    ...
    "cinnamony" => ("cinnamonier", "cinnamoniest"),
    ...
    "clearheaded" => ("clearerhearted", "clearesthearted"),
    ...
    "easy" => ("easier", "easiest"),
    "easygoing" => ("easiergoing", "easiestgoing"),
    "eath" => ("eather", "eathest"),
    ...
    "garbagey" => ("garbagier", "garbagiest"),
    "garbagy" => ("garbagier", "garbagiest"),
    ...
    "hardheaded" => ("harderheaded", "hardestheaded"),
    "hardhearted" => ("harderhearted", "hardesthearted"),
    ...
    "icebergy" => ("icebergier", "icebergiest"),
    "icey" => ("icier", "iciest"),
    ...
    "mazaldik" => ("mazaldiker", "mazaldikest"),
    "mazy" => ("mazier", "maziest"),
    ...
    "sausagey" => ("sausagier", "sausagiest"),
    "sausagy" => ("sausagier", "sausagiest"),
    ...
    "sisterly" => ("sisterlier", "sisterliest"),
    ...
    "vuggy" => ("vuggier", "vuggiest"),
    "vulgar" => ("vulgarer", "vulgarest"),
    "wabbly" => ("wabblier", "wabbliest"),
    "wack" => ("wacker", "wackest"),
